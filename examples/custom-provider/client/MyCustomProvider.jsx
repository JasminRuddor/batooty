...
import { UIPlugin } from '@batooty/core'
import { Provider } from '@batooty/companion-client'
import { ProviderViews } from '@batooty/provider-views'
import { h } from 'preact'

const defaultOptions = {}

export default class MyCustomProvider extends UIPlugin {
  constructor (batooty, opts) {
    super(batooty, opts)
    this.type = 'acquirer'
    ...
    this.provider = new Provider(batooty, {
