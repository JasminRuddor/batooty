...
// instead of the npm version—in a real app use `require('@batooty/companion')`
const bodyParser = require('body-parser')
const session = require('express-session')
const batooty = require('@batooty/companion')
...
app.get('/', (req, res) => {
  ...
  res.send('Welcome to my batooty companion service')
})
...
app.use(batooty.app(batootyOptions).app)
...
batooty.socket(app.listen(3020), batootyOptions)
