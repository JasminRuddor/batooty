# batooty + Companion + Custom Provider Example

This example uses @batooty/companion with a dummy custom provider.
...
corepack yarn build
corepack yarn workspace @batooty-example/custom-provider start
```
